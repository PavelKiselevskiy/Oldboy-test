...
!(function () {
  for (
    ...
    var r = e[i];
    window[r] &&
      !window[r].prototype.remove &&
      (window[r].prototype.remove = t);
  }
})(),
  (function (e) {
    function t() {}
    ...
    var t = "required",
      ...
      h = function (e) {
        ...
        var a = e.async !== !1,
          ...
          u = c(r, "get"),
          d = null;
        "post" === i.toLowerCase() && ((d = c(r, "post")), (u = "")),
          l.open(i, t + u, a),
          l.setRequestHeader(
            "Content-Type",
    ...
    (f.prototype = {
        ...
        for (
          var i = function (i, r) {
              ...
              e.setterEventListener(n, "keyup", e.handlerKeyup, "add"),
                a || e.elements.push({ name: o, value: s, group: l });
            },
            r = 0,
            n = t.length;
          r < n;
      ...
      generateMessage: function (e, t, i) {
        var r = this.messages || this.defaultMessages,
          n =
            (r[t] && r[t][e]) ||
            (this.messages && "string" == typeof this.messages[t] && r[t]) ||
            this.defaultMessages[e] ||
            this.DEFAULT_REMOTE_ERROR;
        i && (n = n.replace(":value", i.toString())),
